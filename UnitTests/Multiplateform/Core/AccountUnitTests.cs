   ...
   public sealed class AccountUnitTests
   {
      ...
      */
      public void Case01_AddAccountUpdateSaved()
      {
         ...
         expectedActivities.Push(ExpectedActivity.ItemAdded(false, serviceName: service.ServiceName, fieldValue: account.ToString()));
         expectedActivities.Push(ExpectedActivity.ItemUpdated(true, accountName: account.ToString(), parentName: service.ToString(), fieldName: nameof(account.Password), fieldValue: string.Empty));
         ...
         // When
         string accountNameBeforeLabel = account.ToString();
         account.Label = newAccountLabel;
         account.Label = newAccountLabel;
         expectedActivities.Push(ExpectedActivity.ItemUpdated(false, accountName: accountNameBeforeLabel, parentName: service.ToString(), fieldName: nameof(account.Label), fieldValue: newAccountLabel));
         string accountNameBeforeIdentifiers = account.ToString();
         account.Identifiers = newIdentifiers;
         account.Identifiers = newIdentifiers;
         expectedActivities.Push(ExpectedActivity.ItemUpdated(true, accountName: accountNameBeforeIdentifiers, parentName: service.ToString(), fieldName: nameof(account.Identifiers), fieldValue: $"({string.Join(", ", newIdentifiers)})"));
         expectedLogAlerts.Push(ExpectedActivity.ItemUpdated(true, accountName: accountNameBeforeIdentifiers, parentName: service.ToString(), fieldName: nameof(account.Identifiers), fieldValue: $"({string.Join(", ", newIdentifiers)})"));
         ...
         account.Options = options;
         expectedActivities.Push(ExpectedActivity.ItemUpdated(false, accountName: account.ToString(), parentName: service.ToString(), fieldName: nameof(account.Options), fieldValue: options.ToString()));
      ...
      */
      public void Case03_DeleteAccountUpdateSaved()
      {
         ...
         // When
         string deletedAccountName = accountLoaded.ToString();
         serviceLoaded.DeleteAccount(accountLoaded);
         expectedActivities.Push(ExpectedActivity.ItemDeleted(true, serviceName: service.ServiceName, fieldValue: deletedAccountName));
         expectedLogAlerts.Push(ExpectedActivity.ItemDeleted(true, serviceName: service.ServiceName, fieldValue: deletedAccountName));
