...
<!-- BEGIN:versions-summary -->At the time of writing, `Upsilon.Apps.Passkey.GUI.WPF`, `Upsilon.Apps.Passkey.Core` and `Upsilon.Apps.Passkey.Utils` are on **1.2.x**; `Upsilon.Apps.Passkey.Interfaces` is on **2.0.x**. Each assembly is versioned independently and may diverge. Always upgrade to the latest release of a component before reporting an issue.<!-- END:versions-summary -->
