...
2. Create a user (`Ctrl+N`). Choose a username and **ordered passkeys**. One passkey is allowed (Core raises `InsufficientPasskeys` until you have at least two); two or more make a real multi-factor onion.
