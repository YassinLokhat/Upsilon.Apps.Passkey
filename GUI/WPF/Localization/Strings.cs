...
namespace Upsilon.Apps.Passkey.GUI.WPF.Localization
{
   ...
   internal static class Strings
   {
      ...
      public static string Msg_ShowPasskeyQualityWarnings => Get(nameof(Msg_ShowPasskeyQualityWarnings));
      ...
      public static string Title_PasskeyQualityWarningsWindow => Get(nameof(Title_PasskeyQualityWarningsWindow));
      ...
      public static string Msg_SecuritySettings_ClipboardCleaningDisabled => Get(nameof(Msg_SecuritySettings_ClipboardCleaningDisabled));
      public static string Label_SecuritySettings_QrAutoCloseDisabled => Get(nameof(Label_SecuritySettings_QrAutoCloseDisabled));
      public static string Msg_SecuritySettings_QrAutoCloseDisabled => Get(nameof(Msg_SecuritySettings_QrAutoCloseDisabled));
      public static string Label_SecuritySettings_NoAccountLeakCheck => Get(nameof(Label_SecuritySettings_NoAccountLeakCheck));
      ...
      public static string Msg_SecuritySettings_IdleLoginDisabled => Get(nameof(Msg_SecuritySettings_IdleLoginDisabled));
      public static string Label_SecuritySettings_OfflineLeakFilterUnavailable => Get(nameof(Label_SecuritySettings_OfflineLeakFilterUnavailable));
      public static string Msg_SecuritySettings_OfflineLeakFilterUnavailable => Get(nameof(Msg_SecuritySettings_OfflineLeakFilterUnavailable));
      public static string Label_SecuritySettings_DuplicatePasswordNotificationsDisabled => Get(nameof(Label_SecuritySettings_DuplicatePasswordNotificationsDisabled));
      public static string Msg_SecuritySettings_DuplicatePasswordNotificationsDisabled => Get(nameof(Msg_SecuritySettings_DuplicatePasswordNotificationsDisabled));
      public static string Label_SecuritySettings_PasswordUpdateReminderNotificationsDisabled => Get(nameof(Label_SecuritySettings_PasswordUpdateReminderNotificationsDisabled));
      public static string Msg_SecuritySettings_PasswordUpdateReminderNotificationsDisabled => Get(nameof(Msg_SecuritySettings_PasswordUpdateReminderNotificationsDisabled));
      public static string Label_SecuritySettings_PasswordLeakedNotificationsDisabled => Get(nameof(Label_SecuritySettings_PasswordLeakedNotificationsDisabled));
      public static string Msg_SecuritySettings_PasswordLeakedNotificationsDisabled => Get(nameof(Msg_SecuritySettings_PasswordLeakedNotificationsDisabled));
      public static string Msg_OpenUserSettingsPrompt => Get(nameof(Msg_OpenUserSettingsPrompt));
