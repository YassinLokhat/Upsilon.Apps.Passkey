...
namespace Upsilon.Apps.Passkey.GUI.MAUI.Localization
{
   ...
   internal static class Strings
   {
      private static readonly ResourceManager _manager = new(
         "Upsilon.Apps.Passkey.GUI.MAUI.Localization.Strings",
         typeof(Strings).Assembly);

      public static CultureInfo? Culture { get; set; }

      public static string Get(string name)
         => _manager.GetString(name, Culture) ?? _manager.GetString(name, CultureInfo.InvariantCulture) ?? name;

      public static string GetNeutral(string name)
         => _manager.GetString(name, CultureInfo.InvariantCulture) ?? name;

      public static string Format(string name, params object?[] args)
         => string.Format(Culture ?? CultureInfo.CurrentUICulture, Get(name), args);
      ...
      // MAUI-only keys (also added to Strings.resx)
      public static string Msg_Copied => Get(nameof(Msg_Copied));
      public static string Msg_EnterUsername => Get(nameof(Msg_EnterUsername));
      public static string Msg_EnterPasskey => Get(nameof(Msg_EnterPasskey));
      public static string Msg_NeedPasskey => Get(nameof(Msg_NeedPasskey));
      public static string Msg_NoServices => Get(nameof(Msg_NoServices));
      public static string Msg_SessionEnded => Get(nameof(Msg_SessionEnded));
      public static string Msg_CreatingDatabase => Get(nameof(Msg_CreatingDatabase));
      public static string Msg_Saved => Get(nameof(Msg_Saved));
      public static string Title_Services => Get(nameof(Title_Services));
      public static string Title_Login => Get(nameof(Title_Login));
      public static string Title_Warnings => Get(nameof(Title_Warnings));
      public static string Label_Passkeys => Get(nameof(Label_Passkeys));
      public static string Label_AddPasskey => Get(nameof(Label_AddPasskey));
      public static string Label_AddService => Get(nameof(Label_AddService));
      public static string Label_AddAccount => Get(nameof(Label_AddAccount));
      public static string Label_Delete => Get(nameof(Label_Delete));
      public static string Label_Edit => Get(nameof(Label_Edit));
