using Upsilon.Apps.PassKey.Core.Abstraction.Events;

namespace Upsilon.Apps.PassKey.Core.Abstraction.Interfaces
{
   /// <summary>
   ...
   public interface IDatabase : IDisposable
   {
      ...
      static IDatabase Create(ICryptographyCenter cryptographicCenter,
         ...
         string username,
         string[] passkeys)
         => Upsilon.Apps.PassKey.Core.Implementation.Models.Database.Create(cryptographicCenter,
            serializationCenter,
            databaseFile,
            autoSaveFile,
            logFile,
      ...
      static IDatabase Open(ICryptographyCenter cryptographicCenter,
         ...
         => Upsilon.Apps.PassKey.Core.Implementation.Models.Database.Open(cryptographicCenter,
            serializationCenter,
            databaseFile,
            autoSaveFile,
            logFile,
